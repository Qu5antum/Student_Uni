...
from src.app.service.course_service import delete_student_courses_by_id, get_course_for_student, get_student_courses_, course_selection_for_student, custom_course_add_for_student
...
@student_route.delete("admin/delet_student_courses/", dependencies=[Depends(require_roles(["ADMIN"]))], status_code=status.HTTP_200_OK)
